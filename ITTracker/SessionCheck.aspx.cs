...
namespace ITTacker
{
    ...
    public partial class SessionCheck : System.Web.UI.Page
    {
        ...
        public void Page_Init(object o, EventArgs e)
        {
            ...
            //oh.ExecuteNonQuery("insert into TBL_BRS_LOG(details,tra_dt) values('" + dtUsrDtls1.Rows[0][0].ToString() + "',sysdate)");
            //19675

            //           23676-mani
            //string userid = "376292";
            // string userid = "319346";
            //string userid = "337545";
            //string userid = "313301";
            //string userid = "23676";
            //string userid = "376078";
            ...
            //307519 joby   murugesan:310463   nidheesh :83652

            //sabitha--313301

            //--18906--Rajeev
            //string userid = Decrypt(HttpUtility.UrlDecode(Request.QueryString["key"]));
            //string userid = Decrypt(HttpUtility.UrlDecode(Request.QueryString["key"]), dtUsrDtls1.Rows[0][0].ToString());
