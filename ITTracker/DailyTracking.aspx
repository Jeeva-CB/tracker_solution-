<%@ Page Title="" Language="C#" MasterPageFile="~/PWA_Master.Master" AutoEventWireup="true" CodeBehind="DailyTracking.aspx.cs" Inherits="ITTracker.DailyTracking" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    <script src="js/Tracker.js?<%=DateTime.Now.Ticks.ToString()%>"></script>
    ...
    <div class="card card-5 rightmarg">
        <form class="form-inline" runat="server" method="post" enctype="multipart/form-data">
           ...
           <label class="col-md-1 align-left ">Date: <span class="required text-danger">*</span> </label>
                 ...
                 <div class="row col-md-12 p-1">
                     <label class="col-md-3 align-left " id="iblgitbranch">GitHub Branch: <span class="required text-danger">*</span> </label>
             <div class="col-md-4 align-left ">
               <input type="text" id="gitbranch" style="width:100%" class="form-control"/>
                 </div>
                     <label class="col-md-1 align-left " id="iblgitrespose">GitHub Repository: <span class="required text-danger">*</span> </label>
             <div class="col-md-3 align-left ">
               <input type="text" id="gitres" style="width:100%" class="form-control"  />
                 </div>
                     </div>
