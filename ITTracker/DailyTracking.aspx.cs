...
namespace ITTracker
{
    public partial class DailyTracking : System.Web.UI.Page
    {
        ...
        [WebMethod(EnableSession = true)]
        public static List<getDropDownData> getFillDatas(string pageVal, string pageval1, string pageval2)
        {
            DataSet ds;
            List<getDropDownData> getData = new List<getDropDownData>();
            ITService.ITServiceClient obj1 = new ITService.ITServiceClient();
        ...
        [WebMethod(EnableSession = true)]
        public static List<getDropDownData> getDescOfWork(string pageVal, string pageval1,string user)
        {
            DataSet ds;
            List<getDropDownData> getData = new List<getDropDownData>();
            ITService.ITServiceClient obj1 = new ITService.ITServiceClient();
            ds = obj1.TrackerSelect(pageVal, pageval1, user, "", "");
